...
| Ruta | Descripción |
|---|---|
| `data/inputs/` | 21 fotografías del conjunto de test usadas para la validación del pipeline. Sin *ground truth* pareado. |
| `data/masks/` | 21 máscaras del conjunto de test usadas para la validación del pipeline. Sin *ground truth* pareado. |
